...
RotateArmatureNodeToolAction::RotateArmatureNodeToolAction(Workspace* a_workspace, Editor* a_editor)
{
    m_workspace = a_workspace;
    m_editor = a_editor;
}
RotateArmatureNodeToolAction::~RotateArmatureNodeToolAction()
{

}

bool RotateArmatureNodeToolAction::Interact(const glm::mat4& a_viewProj, const glm::vec3& a_pos, e_Axis a_axis, const Camera* a_camera, const glm::vec2& a_cursorPos, const glm::vec2& a_screenSize)
{
...
bool RotateArmatureNodeToolAction::LeftClicked(Camera* a_camera, const glm::vec2& a_cursorPos, const glm::vec2& a_screenSize)
{
...
bool RotateArmatureNodeToolAction::LeftDown(Camera* a_camera, const glm::vec2& a_cursorPos, const glm::vec2& a_screenSize)
{
    const glm::vec3 cWorldPos = a_camera->GetScreenToWorld(glm::vec3(a_cursorPos, 0.9f), a_screenSize);

    if (m_editor->GetCurrentActionType() == ActionType_RotateObjectRelative)
    {
        RotateObjectRelativeAction* action = (RotateObjectRelativeAction*)m_editor->GetCurrentAction();
...
bool RotateArmatureNodeToolAction::LeftReleased(Camera* a_camera, const glm::vec2& a_cursorPos, const glm::vec2& a_screenSize)
{
    if (m_editor->GetCurrentActionType() == ActionType_RotateObjectRelative)
    {
...
void RotateArmatureNodeToolAction::Draw(Camera* a_camera)
{
