...
public:
    ...
    static glm::vec2 GetVec2(const tinyxml2::XMLElement* a_element, const glm::vec2& a_default = glm::vec2(0));
    ...
    static glm::vec3 GetVec3(const tinyxml2::XMLElement* a_element, const glm::vec3& a_default = glm::vec3(0));
    ...
    static glm::quat GetQuat(const tinyxml2::XMLElement* a_element);
};