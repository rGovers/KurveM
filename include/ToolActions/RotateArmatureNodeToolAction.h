...
class RotateArmatureNodeToolAction : public ToolAction
{
private:
...
public:
    RotateArmatureNodeToolAction(Workspace* a_workspace, Editor* a_editor);
    virtual ~RotateArmatureNodeToolAction();
