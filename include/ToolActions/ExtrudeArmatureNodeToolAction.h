...
class ExtrudeArmatureNodeToolAction : public ToolAction
{
private:
...
public:
    ExtrudeArmatureNodeToolAction(Workspace* a_workspace, Editor* a_editor);
    virtual ~ExtrudeArmatureNodeToolAction();
